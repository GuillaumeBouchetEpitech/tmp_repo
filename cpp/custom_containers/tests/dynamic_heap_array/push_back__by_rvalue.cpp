...
TEST_F(dynamic_heap_array, push_back__by_rvalue__without_pre_allocation) {
...

  {
    ...
    myArray.push_back(common::TestStructureCopyable(1, "1"));
    ...
    ASSERT_EQ(common::getTotalCopyCtor(), 0);
    ASSERT_EQ(common::getTotalMoveCtor(), 1); // moved the rvalue in the container
    ASSERT_EQ(common::getTotalDtor(), 1); // dtor the rvalue
    ASSERT_EQ(common::getTotalAlloc(), 1);
    ASSERT_EQ(common::getTotalDealloc(), 0);
    common::reset();

    myArray.push_back(common::TestStructureCopyable(2, "2"));
    ...
    ASSERT_EQ(common::getTotalCopyCtor(), 0);
    ASSERT_EQ(common::getTotalMoveCtor(), 2); // also moved the existing value
    ASSERT_EQ(common::getTotalDtor(), 2);
    ASSERT_EQ(common::getTotalAlloc(), 1);
    ASSERT_EQ(common::getTotalDealloc(), 1); // realloc
    common::reset();

    myArray.push_back(common::TestStructureCopyable(3, "3"));
    ...
    ASSERT_EQ(common::getTotalCtor(), 1);
    ASSERT_EQ(common::getTotalCopyCtor(), 0);
    ASSERT_EQ(common::getTotalMoveCtor(), 3); // also moved the existing value
    ASSERT_EQ(common::getTotalDtor(), 3);
    ASSERT_EQ(common::getTotalAlloc(), 1);
    ASSERT_EQ(common::getTotalDealloc(), 1); // realloc
    common::reset();

    myArray.push_back(common::TestStructureCopyable(4, "4"));
...
TEST_F(dynamic_heap_array, push_back__by_rvalue__with_pre_allocation) {
