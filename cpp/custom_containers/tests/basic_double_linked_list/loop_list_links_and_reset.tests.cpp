...
TEST(basic_double_linked_list, can_loop_and_reset_list_a_list_of_1_link) {
  List list;
  Link link1;
  ...
  list.loop_and_reset<int>([&expectedLinks, &totalIteration](int* inUserData) -> void {
...
TEST(basic_double_linked_list, can_loop_and_reset_list_a_list_of_2_links) {
  List list;
  Link link1;
  Link link2;
...
TEST(basic_double_linked_list, can_loop_and_reset_list_a_list_of_3_links) {
  List list;
  Link link1;
  Link link2;
  Link link3;
