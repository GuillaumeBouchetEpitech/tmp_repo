...
TEST(basic_double_linked_list, can_swap_link_in_2_links_list) {
  List list;
  Link link1;
  Link link2;
  ...
  list.swap_two_links_from_same_list(link1, link2);
...
TEST(basic_double_linked_list, can_swap_link_in_3_links_list) {
  List list;
  Link link1;
  Link link2;
  Link link3;
  ...
  list.swap_two_links_from_same_list(link3, link2);
  ...
  list.swap_two_links_from_same_list(link1, link3);
...
TEST(basic_double_linked_list, can_swap_dead_link_in_3_links_list) {
  List list;
  Link link1;
  Link link2;
  Link link3;
  ...
  list.swap_two_links_from_same_list(link2, link4);
